    ...
    <div className='flex min-h-screen items-center justify-center bg-gradient-to-br from-purple-50 to-blue-50'>
      <Container size='sm' className='text-center'>
        <div className='rounded-2xl bg-white p-12 shadow-2xl'>
          {/* Header */}
          <Text size='3xl' fw={700} className='mb-8 text-gray-800'>
            Vocabulary Manga
          </Text>

          <Text size='lg' c='dimmed' className='mb-8 text-gray-600'>
          ...
          <Tabs defaultValue='login' className='w-full'>
            ...
            <Tabs.Panel value='login'>
              <form onSubmit={handleLogin} className='space-y-4'>
                ...
                <ActionButton onClick={() => handleForgotPassword(email)}>
                  Forgot Password?
                </ActionButton>
              </form>
            </Tabs.Panel>
          ...
          {/* Back to Landing */}
          <div className='mt-6'>
            <Button variant='subtle' onClick={() => navigate('/')} className='text-gray-500'>
              ← Back to Landing
            </Button>
          </div>
        </div>
