    ...
    >
      <div className='p-6'>
        <div className='mb-6 text-center'>
          <div
            className={`h-16 w-16 ${iconBgColor} mx-auto mb-4 flex items-center justify-center rounded-full`}
          >
            {icon}
          </div>
          <Text size='xl' fw={700} className='mb-2 text-gray-800'>
            {title}
          </Text>
        </div>
        ...
        <div className='mt-8 flex gap-3'>
          <Button variant='outline' color='gray' onClick={handleSecondaryClick} className='flex-1'>
            {secondaryButtonText}
          </Button>
          <Button variant='filled' color='purple' onClick={handlePrimaryClick} className='flex-1'>
            {primaryButtonText}
          </Button>
        </div>
      </div>
