      ...
      {suggestions?.map((manga) => (
        ...
        >
          ...
          <img 
            ...
            className='h-40 w-28 flex-shrink-0 rounded-lg object-cover'
          ...
          <div className='flex flex-1 flex-col justify-between'>
            <div>
              <h3 className='mb-2 line-clamp-2 text-lg font-bold text-gray-800'           onClick={() => navigate(`/manga/${manga.id}`)}>
