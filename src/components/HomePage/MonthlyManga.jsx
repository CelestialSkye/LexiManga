...
const Trending = () => {
  ...
  if (isMobile) {
    return (
      <section className='w-full overflow-hidden rounded-[16px] bg-black px-6 py-8 mt-4'>
        {/* Text */}
        <div className='mb-6'>
          <h2 className='mb-2 text-2xl font-bold text-white'>Monthly Manga Picks</h2>
        </div>
  ...
  // Desktop layout
  return (
    <section className='w-full overflow-hidden rounded-[16px] bg-black px-6 py-8 mb-4'>
      <div className='flex gap-8'>
        ...
        <div className='w-65 flex-shrink-0 pr-7 pl-7'>
          ...
          <h2 className='pt-5 text-2xl font-bold text-white'>Monthly Manga Picks</h2>
